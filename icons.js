...
const ICONS = {
  folder:
    "M1.5 4.5a1 1 0 0 1 1-1h3.2l1.3 1.4h6.5a1 1 0 0 1 1 1v6.1a1 1 0 0 1-1 1H2.5a1 1 0 0 1-1-1V4.5Z",
  ...
  upload:
    "M8 11V2.5M4.5 6 8 2.5 11.5 6M2.5 11v1.5a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1V11",
  ...
  trash:
    "M2.5 3.5h11M5.5 3.5v-1a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1M4 3.5l.6 10a1 1 0 0 0 1 .9h4.8a1 1 0 0 0 1-.9l.6-10M7 6v6M9 6v6",
  plus: "M8 3v10M3 8h10",
...
const MULTI = {
  compass:
    '<circle cx="8" cy="8" r="6.2"/><path d="M10.5 5.5 9 9l-3.5 1.5L7 7l3.5-1.5Z"/>',
  ...
  external:
    '<path d="M5 3h-2a1 1 0 0 0-1 1v9a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1v-2"/><path d="M9 2h5v5"/><path d="M14 2 8 8"/>',
};
